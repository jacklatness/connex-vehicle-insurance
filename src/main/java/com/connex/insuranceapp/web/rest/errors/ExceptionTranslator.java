package com.connex.insuranceapp.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.connex.insuranceapp.service.EmailAlreadyUsedException ||
            ex instanceof com.connex.insuranceapp.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.connex.insuranceapp.service.InvalidPasswordException
